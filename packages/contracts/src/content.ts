...
export const SiteContentSchema = z.object({
  ...
  programs: z.object({ kicker: z.string().max(300), title: z.string().max(500), cta: z.string().max(160), cards: z.array(z.object({ tag: z.string().max(160), title: z.string().max(300), body: z.string().max(2000), img: ImageSchema, color: z.string().max(80) })).max(50) }),
  ...
  community: z.object({ kicker: z.string().max(300), title: z.string().max(500), body: z.string().max(5000), image: ImageSchema, items: TextListSchema }),
  ...
  profil: z.object({ sejarah: z.object({ kicker: z.string().max(300), title: z.string().max(500), intro: z.string().max(5000), timeline: z.array(z.object({ year: z.string().max(40), text: z.string().max(2000) })).max(100) }), visiMisi: z.object({ kicker: z.string().max(300), title: z.string().max(500), visi: z.string().max(3000), misi: TextListSchema, tujuan: TextListSchema.optional() }), struktur: z.object({ kicker: z.string().max(300), title: z.string().max(500), people: z.array(z.object({ role: z.string().max(200), name: z.string().max(200) })).max(100) }), sambutan: z.object({ kicker: z.string().max(300), title: z.string().max(500), image: ImageSchema, quote: z.string().max(5000), name: z.string().max(200), role: z.string().max(200) }) }),
  akademik: z.object({ kurikulum: z.object({ kicker: z.string().max(300), title: z.string().max(500), intro: z.string().max(5000), sks: z.array(MetricSchema).max(50), clusters: TextListSchema }), kalender: z.object({ kicker: z.string().max(300), title: z.string().max(500), items: z.array(z.object({ d: z.string().max(100), e: z.string().max(2000) })).max(100) }), dosen: z.object({ kicker: z.string().max(300), title: z.string().max(500), intro: z.string().max(5000), people: z.array(z.object({ name: z.string().max(200), field: z.string().max(300), photo: ImageSchema.optional(), details: z.array(z.string().max(300)).max(20).optional() })).max(100) }), laboratorium: z.object({ kicker: z.string().max(300), title: z.string().max(500), labs: z.array(z.object({ name: z.string().max(300), desc: z.string().max(2000) })).max(100) }) }),
